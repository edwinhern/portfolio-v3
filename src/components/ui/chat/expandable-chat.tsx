...
import { IconMessage, IconMessageDots, IconX } from "justd-icons";
...
const ExpandableChatToggle: React.FC<ExpandableChatToggleProps> = ({
	...
	<Button onClick={toggleChat} className={cn("flex items-center justify-center", className)} {...props}>
		{isOpen ? <IconX className="h-6 w-6" /> : icon || <IconMessageDots className="h-6 w-6" />}
		<span className="font-semibold text-sm">Chat with Edwin</span>
	</Button>
);
